    ...
    return (
        <section className="min-h-screen w-full flex items-stretch bg-white">
            ...
            <div className="w-full md:w-1/2 flex flex-col justify-center px-8 py-12 min-h-screen max-w-[500px] mx-auto relative">
                {/* Home icon moved to top right with Tailwind ping animation */}
                ...
                <h2 className="text-5xl font-normal text-center mb-[50px] underline">Sign up</h2>
                ...
                <form className="flex flex-col gap-4">
                    ...
                    <button type="submit" className="bg-[#0C99FF] text-white rounded-[13px] py-3 font-semibold text-lg mt-2 hover:bg-blue-500 cursor-pointer active:scale-95 duration-300 transition w-full">Sign Up</button>
                </form>
                {/* Home icon removed from here */}
                <div className="text-center mt-4 text-gray-700">
                    Already have an account?{' '}
                    <NavLink to="/login" className="text-blue-600 underline hover:text-blue-800">Log in</NavLink>
                </div>
            </div>
        </section>
    )
